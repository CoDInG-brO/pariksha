    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-surface to-background">
      ...
      <div className={`bg-gradient-to-r from-blue-500 to-purple-600 fixed top-0 left-0 right-0 z-50 border-b border-white/10`}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-white">CAT Full Mock Test</h1>
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            <motion.div key={currentQuestionIndex} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="bg-gradient-to-br from-surface to-elevated rounded-2xl p-8 border border-white/10">
              ...
              <div className="mb-6 pb-6 border-b border-white/10">
                <p className="text-sm text-gray-400">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                    currentSection === 0 ? "bg-blue-500/30 text-blue-300" : currentSection === 1 ? "bg-purple-500/30 text-purple-300" : "bg-orange-500/30 text-orange-300"
                  }`}>
              ...
              {/* Question */}
              <div className="mb-8">
                <p className="text-gray-400 text-sm mb-4">Question {questionIndexInSection + 1} of {currentSectionQuestions.length}</p>
