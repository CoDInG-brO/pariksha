    ...
    <div className="bg-slate-100/60 dark:bg-slate-950 pt-4 pb-6 px-4">
      ...
      >
        <div className="flex items-center gap-3 mb-3">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center text-2xl shadow-sm">
            📊
          </div>
          <h1 className="text-xl font-bold text-slate-900">JEE Subject-wise Drills</h1>
        </div>
        <p className="text-slate-600 text-sm mb-4">Choose a subject to practice. Each block mimics the JEE Main pattern with 60 minutes focus time.</p>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-2xl p-6 border border-slate-200/50 shadow-sm hover:shadow-md transition-all">
            ...
            <p className="text-2xl font-bold text-slate-900 mt-2">{totalDuration} Minutes</p>
            <p className="text-[10px] text-slate-600 mt-1 font-medium">60 min × {sections.length} subjects</p>
          </div>
          <div className="bg-white rounded-2xl p-6 border border-slate-200/50 shadow-sm hover:shadow-md transition-all">
            <p className="text-slate-500 text-xs font-semibold uppercase tracking-wider">Total Questions</p>
            <p className="text-2xl font-bold text-slate-900 mt-2">{totalQuestions} Questions</p>
            <p className="text-[10px] text-slate-600 mt-1 font-medium">Sourced from live PCM bank</p>
          </div>
          <div className="bg-white rounded-2xl p-6 border border-slate-200/50 shadow-sm hover:shadow-md transition-all">
            <p className="text-slate-500 text-xs font-semibold uppercase tracking-wider">Total Marks</p>
            <p className="text-2xl font-bold text-slate-900 mt-2">{totalMarks} Marks</p>
            <p className="text-[10px] text-slate-600 mt-1 font-medium">+4 correct, -1 incorrect</p>
          </div>
        </div>
      </motion.div>
                ...
                <div className={`relative rounded-2xl p-6 border border-blue-200/50 bg-white transition-all duration-300 cursor-pointer h-full hover:shadow-lg shadow-sm`}>
                  ...
                  <div className="flex items-center justify-between gap-3 pt-3 border-t border-slate-200">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="px-5 py-2 text-xs bg-gradient-to-br from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white font-medium rounded-md transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer border-0"
                    >
                      Start →
                    </motion.button>
                  </div>
